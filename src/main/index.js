...
function createWindow() {
  ...
  readConfig(getConfigPath(LanguagePath)).then(res => {
    mainWindow.webContents.send('setLanguage', res)
  }).catch(err => {
    dialog.showErrorBox(getConfigPath(LanguagePath), err.message)
    app.quit()
  })
...
export const clientNotion = null
